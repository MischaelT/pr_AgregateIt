    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ask', models.DecimalField(decimal_places=2, max_digits=4)),  # noqa
                ('bid', models.DecimalField(decimal_places=2, max_digits=4)),  # noqa
                ('created', models.DateTimeField(auto_now_add=True)),  # noqa
                ('currency_name', models.CharField(choices=[('USD', 'Dollar'), ('EUR', 'Euro')], default='USD', max_length=3)),  # noqa
                ('currency_type', models.CharField(max_length=8)),  # noqa
                ('source', models.ForeignKey(choices=[('privat_bank', 'Privat bank'), ('oschad_bank', 'Oschad bank'), ('pumb_bank', 'Pumb'), ('mono_bank', 'Mono bank'), ('vkurse_site', 'vkurse.ua'), ('minfin_site', 'minfin.ua')], on_delete=django.db.models.deletion.CASCADE, related_name='rates', to='currency.source')),  # noqa
            ],
        ),
    ]
